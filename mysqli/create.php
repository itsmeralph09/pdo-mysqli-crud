		...
		if ( $_SERVER['REQUEST_METHOD'] == 'POST') {
			...
			do{
				...
				if ( empty($last_name) || empty($first_name) || empty($email) || empty($phone_number) || empty($address)){
					...
					$sql = "INSERT INTO tbl_student(last_name, first_name, extension_name, middle_name, email, phone_number, address)"." VALUES ('$last_name', '$first_name', '$extension_name', '$middle_name', '$email', '$phone_number', '$address')";
